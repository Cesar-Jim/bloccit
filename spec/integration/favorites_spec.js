  ...
  describe("guest attempting to favorite on a post", () => {
    ...
    describe("POST /topics/:topicId/posts/:postId/favorites/create", () => {
      ...
      it("should not create a new favorite", (done) => {
        ...
        // We take note of the number of favorites that exist for the post before sending the 
        // delete request. We then check that the number of favorites has not changed to confirm 
        // no favorite was deleted.
