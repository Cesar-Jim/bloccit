...
describe("routes : comments", () => {
  ...
  describe("guest attempting to perform CRUD actions for Comment", () => {
    ...
    // Write a test to ensure a user who is not signed in is not able to destroy a comment.
  ...
  describe("signed in user performing CRUD actions for Comment", () => {
    ...
    // Write a test to ensure a user who is signed in is able to create a comment.
    describe("POST /topics/:topicId/posts/:postId/comments/create", () => {
    ...
    // Write a test to ensure a user who is signed in is able to destroy a comment.
    describe("POST /topics/:topicId/posts/:postId/comments/:id/destroy", () => {
